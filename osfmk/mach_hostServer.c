...
#pragma pack(push, 4)
	...
	} __Request___kernelrpc_host_create_mach_voucher_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
#pragma pack(push, 4)
	...
	typedef struct {
		...
		/* end of the kernel processed data */
	} __Reply___kernelrpc_host_create_mach_voucher_t __attribute__((unused));
#ifdef  __MigPackStructs
#pragma pack(pop)
#endif
...
union __ReplyUnion__mach_host_subsystem {
	...
	__Reply___kernelrpc_host_create_mach_voucher_t Reply__kernelrpc_host_create_mach_voucher;
...
mig_internal novalue _X_kernelrpc_host_create_mach_voucher
	(mach_msg_header_t *InHeadP, mach_msg_header_t *OutHeadP);
...
#if ( __MigTypeCheck )
#if __MIG_check__Request__mach_host_subsystem__
#if !defined(__MIG_check__Request___kernelrpc_host_create_mach_voucher_t__defined)
#define __MIG_check__Request___kernelrpc_host_create_mach_voucher_t__defined

mig_internal kern_return_t __MIG_check__Request___kernelrpc_host_create_mach_voucher_t(__attribute__((__unused__)) __Request___kernelrpc_host_create_mach_voucher_t *In0P)
{

	typedef __Request___kernelrpc_host_create_mach_voucher_t __Request;
#if	__MigTypeCheck
...
#if defined(__NDR_convert__int_rep__Request___kernelrpc_host_create_mach_voucher_t__recipesCnt__defined)
	if (In0P->NDR.int_rep != NDR_record.int_rep)
		__NDR_convert__int_rep__Request___kernelrpc_host_create_mach_voucher_t__recipesCnt(&In0P->recipesCnt, In0P->NDR.int_rep);
#endif	/* __NDR_convert__int_rep__Request___kernelrpc_host_create_mach_voucher_t__recipesCnt__defined */
#if	__MigTypeCheck
...
#endif /* !defined(__MIG_check__Request___kernelrpc_host_create_mach_voucher_t__defined) */
#endif /* __MIG_check__Request__mach_host_subsystem__ */
#endif /* ( __MigTypeCheck ) */
...
#endif	/* mig_external */
MIG_SERVER_ROUTINE
kern_return_t _kernelrpc_host_create_mach_voucher
(
	host_t host,
...
#pragma pack(pop)
#endif
	typedef __Request___kernelrpc_host_create_mach_voucher_t __Request;
	typedef __Reply___kernelrpc_host_create_mach_voucher_t Reply __attribute__((unused));
	...
	Request *In0P = (Request *) InHeadP;
	Reply *OutP = (Reply *) OutHeadP;
#ifdef	__MIG_check__Request___kernelrpc_host_create_mach_voucher_t__defined
	kern_return_t check_result;
#endif	/* __MIG_check__Request___kernelrpc_host_create_mach_voucher_t__defined */
	...
	kern_return_t RetCode;
	__DeclareRcvRpc(222, "_kernelrpc_host_create_mach_voucher")
	__BeforeRcvRpc(222, "_kernelrpc_host_create_mach_voucher")

#if	defined(__MIG_check__Request___kernelrpc_host_create_mach_voucher_t__defined)
	check_result = __MIG_check__Request___kernelrpc_host_create_mach_voucher_t((__Request *)In0P);
	if (check_result != MACH_MSG_SUCCESS)
		{ MIG_RETURN_ERROR(OutP, check_result); }
#endif	/* defined(__MIG_check__Request___kernelrpc_host_create_mach_voucher_t__defined) */
	...
	RetCode = _kernelrpc_host_create_mach_voucher(In0P->Head.msgh_request_port, In0P->recipes, In0P->recipesCnt, &OutP->voucher.name);
	if (RetCode != KERN_SUCCESS) {
		MIG_RETURN_ERROR(OutP, RetCode);
	}
	...
	OutP->Head.msgh_size = (mach_msg_size_t)(sizeof(Reply));
	OutP->msgh_body.msgh_descriptor_count = 1;
	__AfterRcvRpc(222, "_kernelrpc_host_create_mach_voucher")
}
...
#pragma pack(pop)
	...
	OutP->RetCode = host_set_atm_diagnostic_flag(In0P->Head.msgh_request_port, In0P->diagnostic_flag);
...
#pragma pack(pop)
	...
	OutP->RetCode = host_set_multiuser_config_flags(In0P->Head.msgh_request_port, In0P->multiuser_flags);
...
#pragma pack(pop)
	...
	OutP->RetCode = mach_zone_info_for_zone(In0P->Head.msgh_request_port, In0P->name, &OutP->info);
	if (OutP->RetCode != KERN_SUCCESS) {
		MIG_RETURN_ERROR(OutP, OutP->RetCode);
	}
...
const struct mach_host_subsystem {
	...
	(vm_address_t)0,
	{
		...
		{0, 0, 0, 0, 0, 0},
          { (mig_impl_routine_t) 0,
          (mig_stub_routine_t) _X_kernelrpc_host_create_mach_voucher, 4, 0, (routine_arg_descriptor_t)0, (mach_msg_size_t)sizeof(__Reply___kernelrpc_host_create_mach_voucher_t)},
          { (mig_impl_routine_t) 0,
